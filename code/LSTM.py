...
# Data columns
target_colums = [f"NO{i}_day_ahead_prices" for i in range(1,6)]
load_columns = [f"NO{i}_Actual Load" for i in range(1,6)]
generated_columns = [f"NO{i}_generation_actual" for i in range(1,6)]
load_forecast_columns = [f"NO{i}_Forecasted Load" for i in range(1,6)]
generated_forecast_columns = [f"NO{i}_generation_forecast" for i in range(1,6)]
...
plt.plot(x_plot, t_test_m.flatten())
plt.plot(x_plot, t_hat_test_m.flatten())
plt.show()

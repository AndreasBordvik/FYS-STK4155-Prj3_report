...
dataset_df = pd.read_csv(
    f"data/input_data/entsoe_dataset_main.csv", index_col=[0])
...
test, train = train_test_split(
    dataset_df_preprocessed, test_size=0.8, shuffle=False)
...
generated_forecast_columns = [
    f"NO{i}_generation_forecast" for i in range(1, 6)][4]
...
# Tensorboard
log_dir = f"data/report_data/logs/fit/" + \

...
As previously mentioned, time series consists of data that describes how a different  changes over time. As a result of this aggregation of data, specific characteristics of interest can be decomposed from the original time series. This can be components like trend, 

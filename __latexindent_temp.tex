...
In the case of the latter, a common method for further preprocessing is the use of differenceing. Using this method creates a new time series, consisiting of the differences beteween each value and the next \cite{Korstanje2021}. This new data series is then used to plot 2 new \todo{SKRIV OM autocorr og partial autocorr}

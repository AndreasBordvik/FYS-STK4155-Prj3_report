...
\begin{figure}
  ...
  \caption{\label{fig:univariate_best_predictions} Three sample predictions from the best univariate model ConvGRU}
\end{figure}
...
\begin{figure}
  ...
  \includegraphics[width=\columnwidth]{figures/univariate_predictions_convGRU_testsample24.pdf}
  \includegraphics[width=\columnwidth]{figures/univariate_predictions_convGRU_testsample98.pdf}  
  \caption{\label{fig:multivariate_best_predictions} Three sample predictions from the best multivariate model ????}
\end{figure}
